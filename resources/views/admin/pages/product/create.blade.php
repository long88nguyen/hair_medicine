...
<form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data"> 
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="discount" value="{{ old('discount') }}" min="0" max="100">
                    </div>
                </div>
            </div>
    ...
    <div class="">
        ...
        <textarea id="tinymce-content" class="form-control form-control-sm tinymce-selector" name="content" rows="6" aria-hidden="true"></textarea>
    </div>
    <div class="text-end">
